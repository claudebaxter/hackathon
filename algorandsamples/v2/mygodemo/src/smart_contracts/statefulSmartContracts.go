...
const creatorMnemonic = "retreat black enable border visa camp vital oxygen room addict rose defy any kind replace spike sunset vague daring decide legal wrap diary absent stock"
const userMnemonic = "cradle current kidney banana bacon typical wear wood pave brick owner humor nest vault accuse walk coconut crew foam yellow rapid ready remember abandon roof"
